...
const orderValidation = [
  ...
  body('items.*.quantity')
    ...
    .custom(val => val >= 1).withMessage('Quantity must be at least 1')
];
...
router.put('/:id/status', auth, isTrader, statusValidation, validate, orderController.updateOrderStatus);
